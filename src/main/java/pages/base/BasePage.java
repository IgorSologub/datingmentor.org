...
public class BasePage {
    ...
    private final By mainLogoButton = By.xpath("//a[@class='n7Qt8NJ']");
    private final By headerMenuOpen = By.xpath("//button[@class='VBoN0uQLSJ js-modal-btn']");
    private final By languageMenuOpen = By.xpath("(//a[@class='GyvqV5iZE4 Scv07guv js-header-drop-btn '])[4]");
    ...
    public BasePage headerButtonClick (int numButton) {
        By headerButton = By.xpath("(//a[@class='GyvqV5iZE4 '])[" + numButton + "]");
        driver.findElement(headerButton).click();
        return this;
    }

    public BasePage headerMenuOpen () {
        By headerButton = By.xpath("(//a[@class='GyvqV5iZE4 '])[2]");
    ...
    public BasePage footerButtonClick (int numButton) {
        By footerButton = By.xpath("(//a[@class='UUzxQcmuWlW'])[" + numButton + "]");
